...
## Use the R functions available at (https://github.com/camaradesberlin/tools)
...
3. Load the function(s) you want to run. Currently, the functions are stored in separate scripts. Have a look at the [repository webpage](https://github.com/camaradesberlin/tools/) for more information on each function.
